...
const AllCountryWithTimeZone = [
    ...
    { id: 7, value: "America/Mexico_City", label: "México - Ciudad de mexico", short: "MX" },
    ...
    { id: 29, value: "Mexico/BajaNorte", label: "Chihuahua", short: "MX" },
    { id: 30, value: "Mexico/BajaSur", label: "Tijuana", short: "MX" },
];
...
export function setTimeZone(timeZone) {
  ...
  //   fetch(`${URL_BASE}/usuario/actualizar/timezone/${user_slug}`,{
  //     headers: new Headers({
