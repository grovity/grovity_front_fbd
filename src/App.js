      ...
      <BrowserRouter>
        ...
        <Switch>
          <Route
            ...
            path="/salesforce/:id"
            render={(props) => (
              <SalesForce {...props} id={props.match.params.id} />
            )}
          />
          ...
          <Route
            exact
            path="/confirmation_mail"
            component={Confirmation_mail}
          />
          ...
          <Route
            ...
            path="/user/mentor/:id"
            render={(props) => (
              <UserContainer {...props} id={props.match.params.id} />
            )}
          />
          <Route
          ...
          <Route
            ...
            path="/user/detail/:id"
            render={(props) => (
              <UserContainerData {...props} id={props.match.params.id} />
            )}
          />
          <Route
            exact
          ...
          <PrivateRoute
            exact
            path="/institution"
            component={HomeInstitusionalContainer}
          />
          <PrivateRoute exact path="/posts" component={PostsContainer} />
          ...
          <Route
            ...
            path="/dashboard/:id"
            render={(props) => (
              <Dashboard {...props} id={props.match.params.id} />
            )}
          />
          <Route
            exact
            path="/empresa/:id"
            render={(props) => (
              <EmpresaUser {...props} id={props.match.params.id} />
            )}
          />
          ...
          <PrivateRoute
            exact
            path="/programs/programs/new"
            component={RegisterProgramContainer}
          />
          <PrivateRoute
            exact
            path="/funcionarios/funcionarios/file/new"
            component={NewFuncionarioFileContainer}
          />
          <PrivateRoute
            exact
            path="/users/users/file/new"
            component={NewUserEmprendedorFileContainer}
          />
          <PrivateRoute
            exact
            path="/users/file/new"
          ...
          <PrivateRoute
            exact
            path="/funcionarios"
            component={FuncionariosContainer}
          />
          ...
          <PrivateRoute
            exact
            path="/reports/resumen-entidad-por-programa"
            component={ReportEntityPerProgramContainer}
          />
          <Route
            exact
            path="/programs/programs/mentorships/:id"
            render={(props) => (
              <MentorshipsContainer {...props} id={props.match.params.id} />
            )}
          />
          ...
          <Route
            exact
            path="/gracias-escuela-juntas"
            component={ThanksRegistrationJuntas}
          />
          <Route
            exact
            path="/registro-exitoso"
            component={ThanksRegistration}
          />
          <Route
            exact
            path="/email-confirmacion"
            component={ThanksConfirmationEmail}
          />
          ...
          <Route
            exact
            path="/gracias-juntas-asesoras"
            component={ThanksJuntasAsesoras}
          />
          ...
          <Route
            exact
            path="/programs/programs/:id"
            render={(props) => (
              <ProgramEmprendedor {...props} id={props.match.params.id} />
            )}
          />
          <Route
            exact
            path="/plan/:id/:id_program"
            render={(props) => (
              <PlanTrabajoMenEnti
                {...props}
          ...
          <Route
            exact
            path="/mentors/mentors/:id/edit"
            render={(props) => (
              <MentorContainer {...props} id={props.match.params.id} />
            )}
          />
          <Route
            exact
            path="/programs/programs/mentorships/mentorships/:id/data"
            render={(props) => (
              <MentorshipContainerData {...props} id={props.match.params.id} />
            )}
          />
          <Route
            exact
            path="/mentors/mentors/:id/data"
            render={(props) => (
              <MentorContainerData {...props} id={props.match.params.id} />
            )}
          />
          <Route
            exact
            path="/programs/programs/mentorships/mentorships/:id_m/mentors/:id/data"
            render={(props) => (
              <MentorContainerData
                {...props}
                id_m={props.match.params.id_m}
                id={props.match.params.id}
              />
            )}
          />
          ...
          <Route
            exact
            path="/user_confirmation/:id"
            render={(props) => (
              <ThanksRegistration {...props} id={props.match.params.id} />
            )}
          />
          <Route
            exact
            ...
            render={(props) => (
              <ChangePassSection {...props} id={props.match.params.id} />
            )}
          />
          <Route
            exact
            path="/integraciones"
            render={(props) => (
              <Integraciones {...props} id={props.match.params.id} />
            )}
          />
          <Route
            exact
            path="/soporte"
            render={(props) => (
              <SoporteContainer {...props} id={props.match.params.id} />
            )}
          />
          <Route
            path="/calendar/event/files/:id"
            render={(props) => (
              <FilesContainer {...props} id={props.match.params.id} />
            )}
          />
          <Route
            path="/files/user/:id"
            render={(props) => (
              <FilesContainer_user {...props} id={props.match.params.id} />
            )}
          />
          <Route
            path="/posts/:id"
            render={(props) => (
              <PostContainer {...props} id={props.match.params.id} />
            )}
          />
          <Route
            path="/video/:id"
