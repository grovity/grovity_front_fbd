...
// export let URL_BASE = 'https://devel-api-fundacion-bolivar.grovity.co'
export let URL_BASE = "https://api-desarrollo.grovity.co"

// export let URL_BASE = 'https://api.grovity.co'

export let URL_BASE_GOLANG = "https://zoom-events.grovity.co"


export let URL_MARKETPLACE = "https://mentor-marketplace.grovity.co"
...
} else if(process.env.REACT_APP_SERVER === "fndbolivar-developer") {
    URL_BASE = "https://devel-api-fundacion-bolivar.grovity.co"
    URL_MARKETPLACE = "https://devel-mentor-marketplace-fundacion-bolivar.grovity.co"
    URL_BASE_GOLANG = "https://devel-zoom-events-fundacion-bolivar.grovity.co"     
}
