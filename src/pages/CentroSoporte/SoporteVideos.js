...
import VideosSoporte from "../../components/VideosSoporte/VideosSoporte";
...
class SoporteVideos extends Component {
    state = {
        isMobile,
        showShadow: false,
    };
    ...
    render() {
        return (
            <React.Fragment>
                ...
                {/* <VideosSoporte key="soporte-metodo" isMobile={this.state.isMobile}/> */}
