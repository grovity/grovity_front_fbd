...
export async function setUpGoogleCalendar() {
    const request = await fetch(`${URL_BASE}/usuario/synccalendar/login/gcalendar`, {
        headers: new Headers({
            'Authorization': `Token ${localStorage.getItem("token")}`
        }),
...
export async function setOutlookcalendar() {
    const request = await fetch(`${URL_BASE}/usuario/synccalendar/login/outlook`, {
        headers: new Headers({
            'Authorization': `Token ${localStorage.getItem("token")}`
        }),
...
export async function setUpManualCalendar() {
    const request = await fetch(`${URL_BASE}/usuario/synccalendar/login/manual`, {
        headers: new Headers({
            'Authorization': `Token ${localStorage.getItem("token")}`
        }),
...
export async function syncCalendarV2(calendar) {
    const request = await fetch(`${URL_BASE}/usuario/synccalendar/login/${calendar}`, {
        headers: new Headers({
            'Authorization': `Token ${localStorage.getItem("token")}`
        }),
        method: 'GET'
...
export async function getDailyAvailability(id, date) {
    const request = await fetch(`${URL_BASE}/usuario/synccalendar/sync/${id}/${date}`, {
        headers: new Headers({
            'Authorization': `Token ${localStorage.getItem("token")}`
        }),
        method: 'GET'
