...
export async function getEventsbyUser() {
    ...
    if (json2.status === 401) {
        toast.error('No tiene permisos para acceder a este contenido')
        //navigate to login 
...
export async function setUpGoogleCalendar() {
    ...
    if (request.status === 200) {
        toast.success("Revisa tu correo para completar la sincronizacion con Google Calendar")}
