...
const EventEditMentorForm = (props) => {
    ...
    const [inicio, setInicio] = useState(colTimeZonetoOtherTimeZone(event?.fecha_inicio, timeZoneLocal.value))
    const [fin, setFin] = useState(colTimeZonetoOtherTimeZone(event?.fecha_fin, timeZoneLocal.value))
    ...
    return (
        <Form id='edit-event-mentor'
              ...
              initialValues={{
                  ...
                  fecha_inicio: moment(inicio, 'YYYY-MM-DD HH:mm'),
                  fecha_fin: moment(fin, 'YYYY-MM-DD HH:mm'),
                  mentor: event?.mentor,
                  tipo: event?.tipo,
        ...
        >
            ...
            <Col lg={24} md={24} sm={24} xs={24}>
                    <p>Zona horaria <span>{timeZoneLocal.short}</span></p>
                </Col>
            </Row>
                <Col lg={24} md={24} sm={24} xs={24}>
                    <Row>
