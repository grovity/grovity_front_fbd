...
const EdicionPerfilEntidad = (props) => {
  console.log(props.mt)
    ...
    let arrayMentores = ['Miembro de junta','Consultor','Mentor',]
    if (props.mt){
        arrayMentores = ['Miembro de junta','Consultor','Mentor',props.mt]
    }
    let arrayEmprendedores = ['Emprendedor','Empresario','Mentee' ]
    if (props.et){
        arrayEmprendedores = ['Emprendedor','Empresario','Mentee',props.et]
    }
    ...
    const [itemsEmprendedor, setItemsEmprendedor] = useState(arrayEmprendedores);
    const [itemsMentor, setItemsMentor] = useState(arrayMentores);
    if(props.mt){
