...
import {getPaises,setUpGoogleCalendar,setOutlookcalendar,setUpManualCalendar,syncCalendarV2} from "../../api/user";
                        ...
                        <Row>
                            ...
                            <Col lg={11} md={11} sm={24} xs={24}>
                                ...
                                <Form.Item
                                    ...
                                    // rules={[{required: true, message: 'Por favor ingrese su numero de telefono!'}]}
                                >
                                    <Select placeholder="Seleccionar..." onChange={handleCalendarChange}>
