...
const SignupFormProgramas = (props) => {
        ...
        <div className="signup-form-container">
            <Row>
                <Col>
                    ...
                    <Switch className='switch-header-programas'  checkedChildren="Soy Participante del programa" unCheckedChildren="Soy Consultor o Mentor" defaultChecked onChange={onChange}/>
                    </div>
                    <h2>Crear Cuenta</h2>
