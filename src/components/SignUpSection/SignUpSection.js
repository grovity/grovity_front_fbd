                    ...
                    <Col lg='24' className="loginContainer">
                        <Row className="secondary-row">
                            <Col md='7' lg='12' className='login-pic'>
                                ...
                                <h2>Conecta con tus clientes y escala tu negocio freelance</h2>
                                <p>Crea tu perfil como freelancer, organiza tus eventos y sesiones virtuales, administra un número ilimitado de clientes, realiza y graba todas las videollamadas con tus clientes, recibe calificaciones y comentarios, y mucho más</p>
