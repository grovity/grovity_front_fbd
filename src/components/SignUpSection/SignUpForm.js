...
const SignupForm = (props) => {
      ...
      values(formData).some((value) => {
        ...
        if (validCount !== size(formData)) {
            ...
            if (!isEmailValid(formData.email)) {
                ...
                formData.password = encriptarValor(PUBLIC_KEY, formData.password)
                formData.confirm_password = encriptarValor(PUBLIC_KEY, formData.confirm_password)
                formData.email = encriptarValor(PUBLIC_KEY, formData.email) 
                formData.first_name = encriptarValor(PUBLIC_KEY, formData.first_name)
                formData.last_name = encriptarValor(PUBLIC_KEY, formData.last_name)
    ...
    return (
        <div className="signup-form-container">
            <Row>
                <Col>
                    <Switch checkedChildren="Personas" unCheckedChildren="Empresas" defaultChecked onChange={onChange}/>
                    <h2>Crear Cuenta</h2>
                    <p>Accede a más de 80 mentores expertos</p>
            ...
            >
                ...
                <Form.Item>
                    <Button type="primary" block htmlType="submit" className="login-form-button">
                        {!signUpLoading ? "Crear cuenta" : <Spinner style ={{width:'1rem',height:'1rem'}} animation="border"/>}
                    </Button>
