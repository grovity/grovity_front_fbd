            ...
            >
              ...
              <Col xs={20} sm={20} md={22} lg={16} className="inicio-rapido">
                ...
                <p>
                  ...
                  sido transferida la información a cualquier título. Al
                  proporcionar sus datos personales el USUARIO acepta que estos
                  hagan parte de la base de datos que genera el sitio web o
                  GROVITY, INC. / GROVITY S.A.S. y que ésta sea incluída, junto
                  con su información, en los activos del sitio web o GROVITY,
                  INC. / GROVITY S.A.S. para las operaciones de venta, fusión,
                  escisión o cualquier otra operación comercial.
                  <br></br>
                  ...
                  en cualquier momento solicitar la corrección, rectificación, o
                  actualización de la información proporcionada. Cuando la
                  Superintendencia de Comercio encuentre que el propietario ha
                  incumplido con la política de protección de datos acá
                  establecida o con los mínimos señalados por la ley el USUARIO
                  podrá solicitar la supresión de sus datos personales tanto del
                  sitio web como de las bases de datos de GROVITY, INC. /
                  GROVITY S.A.S. y terceros a los que les haya sido transferida
                  a cualquier título. Términos de respuesta: el propietario
                  ...
                  respuesta será de 15 (quince) días hábiles. <br></br>
                  <br></br>
                ...
                <p>
                  ...
                  sitio a funcionar más rápidamente y prestar un mejor servicio.<br></br>
                  ...
                  S.A.S. acepta su uso. <br></br>El deshabilitar el uso de cookies en
                  puede causar que el sitio no funcione de manera adecuada, con
                  poca velocidad, con errores o que presente fallas que no
                  permitan el uso por parte del USUARIO
                </p>
                <p>
