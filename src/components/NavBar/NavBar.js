...
const NavBar = (props) => {
  ...
  const menu = (
    <Menu>
      <Menu.Item>
        <Link to={`/marketplace`}>BUSCAR MENTORES</Link>
      </Menu.Item>
      <Menu.Item>
        <a href="https://consultor.grovity.co/landing">CONVIERTETE EN MENTOR</a>
      </Menu.Item>
      <Menu.Item>
        <a href="https://grovity.notion.site/Ejecutivo-de-Ventas-B2C-58177dbdbce6441297fc9590f85568aa">
          TRABAJA CON NOSOTROS
        </a>
      </Menu.Item>
      {!localStorage.getItem("token") && (
        <Menu.Item>
          <a href={"https://consultor.grovity.co/landing"}>REGISTRO</a>
        </Menu.Item>
      )}
      {!localStorage.getItem("token") && (
        <Menu.Item>
  ...
  useEffect(() => {
    //get token if not exists go to grovity home
    if (!localStorage.getItem("token")) {
        //detect if route is / 
        if (window.location.pathname === "/") {
            window.location.href = "https://www.grovity.co/";
        }
    }
  });
          ...
          <Row align="middle">
              ...
              <Link to={"/"}>
                <img
                  ...
                  src={
                    ...
                    "/static/imgs/nuevo_home/medium/logo-blanco0,5.png"
                  }
                />
              </Link>
            </Col>
            {isMobile ? (
              ...
              <>
                ...
                >
                  <a
                    href="https://grovity.notion.site/Ejecutivo-de-Ventas-B2C-58177dbdbce6441297fc9590f85568aa"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Button className="btns-navbar" type="link">
                      TRABAJA CON NOSOTROS
                    </Button>
                  </a>
                </Col>
                ...
                >
                  <a
                    href="https://consultor.grovity.co/landing"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Button className="btns-navbar" type="link">
