        ...
        <header className={state}>
            <Row justify='center'>
                <Col xxl={20} xl={20} lg={20} md={22} sm={22} xs={22}>
                    <Row align='middle'>
                        <Col className='col-logo' xxl={100} xl={100} lg={7} md={!isMobile ? 7 : logged ? 18 : 22} sm={ logged ? 17 : 22} xs={logged ? 17 : 21}>
                            <Link to={'/'}>
                        ...
                        </Col>
                        {
                            ...
                            <>
                                ...
                                <Col className='cols-btns-navbar' xxl={4} xl={5} lg={6} md={3} sm={22} xs={22}>
                                    <a href='https://grovity.notion.site/Ejecutivo-de-Ventas-B2C-58177dbdbce6441297fc9590f85568aa' target='_blank' rel='noopener noreferrer'>
                                        <Button className='btns-navbar' type='link'>TRABAJA CON NOSOTROS</Button>
                                    </a>
                                </Col>
                                <Col className='cols-btns-navbar' xxl={3} xl={4} lg={5} md={3} sm={22} xs={22}>
                                    <Link to={`/marketplace`}>
