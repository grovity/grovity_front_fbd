...
import {Layout, Menu, Breadcrumb, Row, Popover,Modal} from 'antd';
...
import EventCreateFast from '../EventCreateFast/EventCreateFast';
import SwitchEntidad from '../SwitchEntidad/SwitchEntidad';
import {VscBellDot , VscBell , VscRemoteExplorer} from "react-icons/vsc";
...
const AppFrame = ({children, auth: {isAuthenticated}, entidad, username, status,user, id, logout, et_plural}) => {
    ...
    const [entidadSwitch, setEntidadSwitch] = useState(user?.switch_entity);
    const [showModalMentor, setShowModalMentor] = useState(false)
    //exmaple 
    
    const is_pending_invoices = localStorage.getItem('is_pending_invoices')
                    ...
                    <Sider collapsible
                        ...
                        <Menu theme={lightDark ? 'light' : "dark"} defaultSelectedKeys={['2']} mode="inline" style={{position: 'sticky', top: '1%'}}>
                            ...
                            <Menu.Item key="7" icon={<QuestionCircleOutlined/>}>
                                <a target='_blank' href='https://grovity.atlassian.net/servicedesk/customer/portal/5/group/8/create/38' rel="noopener noreferrer">Soporte</a>
                            </Menu.Item>
                            <Menu.Item key="8"
                                       icon={<ImportOutlined/>}
                                       onClick={logout}>
                ...
                <Layout className="site-layout">
                    <Header className="site-layout-background" style={{padding: 0}}>
                        <div className='avatar-topbar'>
                            <a href='https://www.youtube.com/playlist?list=PLTcDB9EmpPUYQ8Tqkmvlo9YfD8imCstaC'
                ...
                {isMobile ?
                    ...
                    <Sider collapsible collapsed={collapsed} onCollapse={onCollapse}>
                        ...
                        <Menu theme={lightDark ? 'light' : "dark"} defaultSelectedKeys={['2']} mode="inline" style={{position: 'sticky', top: '1%'}}>
                            ...
                            {/* {
                                is_pending_invoices ?
                            <Menu.Item key="4" icon={<VscBellDot/>}>

                            Facturacion 
                            <Link to="/facturacion"/>
                            </Menu.Item>
                            :
                            <Menu.Item key="4" icon={<VscBell/>}>

                            Facturacion 
                            <Link to="/facturacion"/>
                            </Menu.Item>
                            } */}
                            <Menu.Item onClick={() => openModalMentor()} key="5" icon={<VscRemoteExplorer/>}>
...
<Modal
                                    ...
                                    footer={[]}
                                >
                                    <EventCreateFast setVisible={setShowModalMentor}/>
                                </Modal>
                            </Menu>
                            <Menu theme={lightDark ? 'light' : "dark"} defaultSelectedKeys={['2']} mode="inline" style={{position: 'sticky', top: '72%'}}>
                            {!collapsed && entidadSwitch?
                              <Menu.Item key="6" >
                              <div className='entidad-entidad'>
  
  <span >Entidad:<SwitchEntidad className="swir"/></span>
  </div>
