        ...
        <>
            <Form id='acta-crear-form'
                  ...
                  initialValues={{
                      assistants: [],
                      summary: '',
                      start_date: moment(colTimeZonetoOtherTimeZone(event.fecha_inicio,timeZone.value), dateFormat),
                      end_date: moment(colTimeZonetoOtherTimeZone(event.fecha_fin,timeZone.value), dateFormat),
                  }}
                  scrollToFirstError
                  labelAlign="right"
            >
