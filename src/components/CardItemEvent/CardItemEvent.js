                        ...
                        <p><strong>Inicio: </strong>
                            {
                                event.marketplace ?
                                    <Moment format="DD/MM  h:mm A z" utc
                                            local>{moment(status ? event && event.fecha_inicio : event && event.fecha_inicio).local('America/Bogota')}</Moment> :
                                    <Moment format="DD/MM  h:mm A z" utc
                                            local>{moment(status ? event && event.start : event && event.inicio).local('America/Bogota')}</Moment>
                        ...
                        <p><strong>Fin: </strong>
                            {
                                event.marketplace ?
                                    <Moment format="DD/MM  h:mm A z" utc
                                            local>{moment(status ? event && event.fecha_fin : event && event.fecha_fin).local('America/Bogota')}</Moment> :
                                    <Moment format="DD/MM  h:mm A z" utc
                                            local>{moment(status ? event && event.end : event && event.fin).local('America/Bogota')}</Moment>
